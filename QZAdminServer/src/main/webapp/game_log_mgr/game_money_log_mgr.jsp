...
<table id="money_log_table"></table>
<!-- 钻石日志 -->
...
function ready(){
	...
	$("#money_log_table").flexigrid({
		url : 'game_log_mgr/get_game_money_log_list.jsp',
   	    dataType : 'json',
...
function searchMoneyLog(){
	...
	$("#money_log_table").flexOptions({
		params:params,
		newp:1
	});
	$("#money_log_table").flexReload();
}
