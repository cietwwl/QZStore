...
public final class EternalLoggerTable extends com.ks.access.DBBeanTable<com.ks.db.log.EternalLogger>{
public static EternalLoggerTable instance;
public static final String TABLE_NAME="t_eternal_logger";
...
public EternalLoggerTable(){
mapper=new DBRowMapper_EternalLogger();
}
@Override
public Object getDBFieldValue(com.ks.db.log.EternalLogger bean, String fname){
if(ID.equals(fname)){
return bean.getId();
}
...
return com.ks.db.log.EternalLogger.class;
}
public final static class DBRowMapper_EternalLogger implements com.ks.access.mapper.RowMapper<com.ks.db.log.EternalLogger>{
@Override
public com.ks.db.log.EternalLogger rowMapper(java.sql.ResultSet rs) throws java.sql.SQLException{
com.ks.db.log.EternalLogger bean = new com.ks.db.log.EternalLogger();
