...
public final class HeroExpPoolLoggerTable extends com.ks.access.DBBeanTable<com.ks.db.log.HeroExpPoolLogger>{
public static HeroExpPoolLoggerTable instance;
public static final String TABLE_NAME="t_hero_exp_pool_logger";
...
public HeroExpPoolLoggerTable(){
mapper=new DBRowMapper_HeroExpPoolLogger();
}
@Override
public Object getDBFieldValue(com.ks.db.log.HeroExpPoolLogger bean, String fname){
if(ID.equals(fname)){
return bean.getId();
}
...
return com.ks.db.log.HeroExpPoolLogger.class;
}
public final static class DBRowMapper_HeroExpPoolLogger implements com.ks.access.mapper.RowMapper<com.ks.db.log.HeroExpPoolLogger>{
@Override
public com.ks.db.log.HeroExpPoolLogger rowMapper(java.sql.ResultSet rs) throws java.sql.SQLException{
com.ks.db.log.HeroExpPoolLogger bean = new com.ks.db.log.HeroExpPoolLogger();
