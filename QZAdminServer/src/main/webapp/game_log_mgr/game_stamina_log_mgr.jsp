...
<table id="stamina_log_table"></table>
<!-- 体力日志 -->
...
function ready(){
	...
	$("#stamina_log_table").flexigrid({
		url : 'game_log_mgr/get_game_stamina_log_list.jsp',
   	    dataType : 'json',
...
function searchMoneyLog(){
	...
	$("#stamina_log_table").flexOptions({
		params:params,
		newp:1
	});
	$("#stamina_log_table").flexReload();
}
