...
function ready(){
	...
	$("#hero_log_table").flexigrid({
		url : 'game_log_mgr/get_game_hero_log_list.jsp',
   	    dataType : 'json',
...
function searchMoneyLog(){
	...
	$("#hero_log_table").flexOptions({
		params:params,
		newp:1
	});
	$("#hero_log_table").flexReload();
}
