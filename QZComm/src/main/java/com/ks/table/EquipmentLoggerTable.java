...
public final class EquipmentLoggerTable extends com.ks.access.DBBeanTable<com.ks.db.log.EquipmentLogger>{
public static EquipmentLoggerTable instance;
public static final String TABLE_NAME="t_equipment_logger";
...
public EquipmentLoggerTable(){
mapper=new DBRowMapper_EquipmentLogger();
}
@Override
public Object getDBFieldValue(com.ks.db.log.EquipmentLogger bean, String fname){
if(ID.equals(fname)){
return bean.getId();
}
...
return com.ks.db.log.EquipmentLogger.class;
}
public final static class DBRowMapper_EquipmentLogger implements com.ks.access.mapper.RowMapper<com.ks.db.log.EquipmentLogger>{
@Override
public com.ks.db.log.EquipmentLogger rowMapper(java.sql.ResultSet rs) throws java.sql.SQLException{
com.ks.db.log.EquipmentLogger bean = new com.ks.db.log.EquipmentLogger();
