...
public final class GoldLoggerTable extends com.ks.access.DBBeanTable<com.ks.db.log.GoldLogger>{
public static GoldLoggerTable instance;
public static final String TABLE_NAME="t_gold_logger";
...
public GoldLoggerTable(){
mapper=new DBRowMapper_GoldLogger();
}
@Override
public Object getDBFieldValue(com.ks.db.log.GoldLogger bean, String fname){
if(ID.equals(fname)){
return bean.getId();
}
...
return com.ks.db.log.GoldLogger.class;
}
public final static class DBRowMapper_GoldLogger implements com.ks.access.mapper.RowMapper<com.ks.db.log.GoldLogger>{
@Override
public com.ks.db.log.GoldLogger rowMapper(java.sql.ResultSet rs) throws java.sql.SQLException{
com.ks.db.log.GoldLogger bean = new com.ks.db.log.GoldLogger();
