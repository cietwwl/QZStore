...
<table id="hero_exp_log_table"></table>
<!-- 伙伴经验池日志 -->
...
function ready(){
	...
	$("#hero_exp_log_table").flexigrid({
		url : 'game_log_mgr/get_game_hero_exp_pool_log_list.jsp',
   	    dataType : 'json',
...
function searchMoneyLog(){
	...
	$("#hero_exp_log_table").flexOptions({
		params:params,
		newp:1
	});
	$("#hero_exp_log_table").flexReload();
}
