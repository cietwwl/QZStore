...
public final class PropLoggerTable extends com.ks.access.DBBeanTable<com.ks.db.log.PropLogger>{
public static PropLoggerTable instance;
public static final String TABLE_NAME="t_prop_logger";
...
public PropLoggerTable(){
mapper=new DBRowMapper_PropLogger();
}
@Override
public Object getDBFieldValue(com.ks.db.log.PropLogger bean, String fname){
if(ID.equals(fname)){
return bean.getId();
}
...
return com.ks.db.log.PropLogger.class;
}
public final static class DBRowMapper_PropLogger implements com.ks.access.mapper.RowMapper<com.ks.db.log.PropLogger>{
@Override
public com.ks.db.log.PropLogger rowMapper(java.sql.ResultSet rs) throws java.sql.SQLException{
com.ks.db.log.PropLogger bean = new com.ks.db.log.PropLogger();
