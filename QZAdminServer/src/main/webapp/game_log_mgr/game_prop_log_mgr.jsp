...
function ready(){
	...
	$("#prop_log_table").flexigrid({
		url : 'game_log_mgr/get_game_prop_log_list.jsp',
   	    dataType : 'json',
...
function searchMoneyLog(){
	...
	$("#prop_log_table").flexOptions({
		params:params,
		newp:1
	});
	$("#prop_log_table").flexReload();
}
