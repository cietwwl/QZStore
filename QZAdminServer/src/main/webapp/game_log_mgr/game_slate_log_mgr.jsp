...
<table id="slate_log_table"></table>
<!-- 石板日志 -->
...
function ready(){
	...
	$("#slate_log_table").flexigrid({
		url : 'game_log_mgr/get_game_slate_log_list.jsp',
   	    dataType : 'json',
...
function searchMoneyLog(){
	...
	$("#slate_log_table").flexOptions({
		params:params,
		newp:1
	});
	$("#slate_log_table").flexReload();
}
