...
public final class DiamondLoggerTable extends com.ks.access.DBBeanTable<com.ks.db.log.DiamondLogger>{
public static DiamondLoggerTable instance;
...
public DiamondLoggerTable(){
mapper=new DBRowMapper_DiamondLogger();
}
@Override
public Object getDBFieldValue(com.ks.db.log.DiamondLogger bean, String fname){
if(ID.equals(fname)){
return bean.getId();
}
...
return com.ks.db.log.DiamondLogger.class;
}
public final static class DBRowMapper_DiamondLogger implements com.ks.access.mapper.RowMapper<com.ks.db.log.DiamondLogger>{
@Override
public com.ks.db.log.DiamondLogger rowMapper(java.sql.ResultSet rs) throws java.sql.SQLException{
