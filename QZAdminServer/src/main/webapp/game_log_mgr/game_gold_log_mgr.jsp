...
function ready(){
	...
	$("#gold_log_table").flexigrid({
		url : 'game_log_mgr/get_game_gold_log_list.jsp',
   	    dataType : 'json',
...
function searchMoneyLog(){
	...
	$("#gold_log_table").flexOptions({
		params:params,
		newp:1
	});
	$("#gold_log_table").flexReload();
}
