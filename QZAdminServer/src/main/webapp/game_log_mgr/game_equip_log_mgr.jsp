...
<table id="equip_log_table"></table>
<!-- 装备日志  -->
...
function ready(){
	...
	$("#equip_log_table").flexigrid({
		url : 'game_log_mgr/get_game_equip_log_list.jsp',
   	    dataType : 'json',
...
function searchMoneyLog(){
	...
	$("#equip_log_table").flexOptions({
		params:params,
		newp:1
	});
	$("#equip_log_table").flexReload();
}
